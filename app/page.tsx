  ...
  return (
    <>
      <section className="mx-10 mt-50 ml-50">
        ...
        <Link href="https://github.com/GoranSalzmann" className="inline-flex items-center border rounded-lg p-1.5 mt-4 w-fit mr-3 hover:scale-105 active:rotate-2 px-4">Mein Github
        ...
        <Link href="/" className="inline-flex items-center border rounded-lg p-1.5 mt-4 w-fit mr-3 hover:scale-105 active:rotate-2 px-4">Mein LinkedIn
